...
{
    cout<<"FOLLOW data aim is:"<<Data->target.latitude << " "<<Data->target.longitude<<endl;
  if (Data)
    followData = *Data;
  else
    resetData();
...
{
    cout<<"FOLLOW data aim is:"<<endl;
  if (Data)
    followData = *Data;
 // else
  //  resetData();

  cout<<"FOLLOW data aim is:"<<followData.target.latitude << " "<<followData.target.longitude<<endl;
