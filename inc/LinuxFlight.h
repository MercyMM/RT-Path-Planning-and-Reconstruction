...
!*/
int moveWithVelocity(CoreAPI* api, Flight* flight, float32_t xVelocityDesired, float32_t yVelocityDesired, float32_t zVelocityDesired, float32_t yawRateDesired ,  int timeoutInMs = 2000, float yawRateThresholdInDegS = 0.5, float velThresholdInMs = 0.1);
