...
//      double deltaLon = goal_P.longitude - curPosition.longitude;
//      double deltaLat = goal_P.latitude - curPosition.latitude;
//      double x =  deltaLat * C_EARTH;
//      double y = deltaLon * C_EARTH * cos(target->latitude);
//      goal.x = x;
//      goal.y = y;
  }
}
